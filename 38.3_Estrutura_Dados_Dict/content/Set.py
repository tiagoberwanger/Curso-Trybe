...
# Ao inicializar com valores de uma lista, os valores duplicados
# serão desconsiderados e a ordem de inserção será perdida.
...
# sets admitem objetos mistos. Ou seja, admitem ter _strings_ com _ints
...
# set é um objeto iterável, mas não conseguimos garantir
# em que ordem os elementos serão acessados.
# A função pop () é útil quando queremos trabalhar com algum elemento
# do set, mas não sabemos de antemão quais elementos estão dentro dele.
